...
export default function SliderVideos() {
  ...
  return (
    ...
    <div className="relative w-full z-[1] pt-8 pb-16 lg:py-24">
      ...
      {/* CONTROLS */}
      <button
        className="absolute max-lg:left-[20%] lg:left-1/2 lg:-translate-x-[150px] bottom-0 bg-mainBlue disabled:bg-mainBlue/70 desabled:cursor-not-allowed rounded-full p-2 z-[99]"
        disabled={active === -1}
        onClick={() => {
          setActive((current) => {
