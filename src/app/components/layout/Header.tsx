...
export default function Header() {
  return (
    <header className="bg-mainBlue shadow fixed top-0 w-full left-1/2 -translate-x-1/2 m-auto z-[99] px-5 py-3 lg:px-16 lg:py-5 flex justify-between max-w-[1920px] items-center">
      <Image
        src={logo}
