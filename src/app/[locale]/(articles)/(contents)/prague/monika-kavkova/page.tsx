...
const titleEN = "Dr. Kavkovà Monika | Lip Rejuvenation for Mature Women";
const descriptionEN =
  "Read the article by Dr. Monika Kavkovà, Scientific Director of the Prague Lab Congress, on lip and perioral area rejuvenation for mature women.";

const titleFR =
  "Dr Kavkovà Monika | Rajeunissement des lèvres pour femme mature";
const descriptionFR =
  "Découvrez l'article du Dr Monika Kavkovà, Directrice scientifique du Congrès Prague Lab sur le rajeunissement des lèvres et de la région Peri-orale chez les femmes matures.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Monika_Kavkova");
