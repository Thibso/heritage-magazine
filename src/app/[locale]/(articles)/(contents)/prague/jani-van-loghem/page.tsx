...
import header from "@/app/img/articles/jani-van-loghem/dr-jani-van-loghem.png";
import logo from "@/app/img/articles/jani-van-loghem/uma-academy.png";
...
const titleEN = "Dr. Jani van Loghem | Injection Volume for Fillers";
const descriptionEN =
  "Discover Dr. Jani van Loghem's exclusive article on the safest injection volumes in high-risk facial areas. Best practices for fillers in aesthetic medicine.";

const titleFR = "Dr Jani van Loghem | Volume d'injection pour les fillers";
const descriptionFR =
  "Découvrez l'article exclusif du Docteur Jani van Loghem sur les volumes d'injection les plus surs dans les zones faciales à haut risque. Bonnes pratiques pour les fillers en médecine esthétique.";
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button
                link="https://academy.uma-institute.com/jani-van-loghem"
                target="_blank"
              >
                {t("cta_text")}
              </Button>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://academy.uma-institute.com/jani-van-loghem"
            target="_blank"
            title="UMA Academy"
