...
import header from "@/app/img/articles/prague/eva-osvaldova/Osvaldova-eva-heritage-magazine.png";
import logo from "@/app/img/articles/prague/eva-osvaldova/prague-lab-congres-innovation-medecine-esthetique.png";
...
const titleEN =
  "Aesthetic Medicine Technologies to Watch | Prague Lab Aesthetic Dialogue";
const descriptionEN =
  "Discover all the aesthetic medicine market technologies to follow closely in 2026. An article dedicated to technological innovation co-authored by Ms. Eva Osvaldovà & Mr. Julien Vervel for the Prague Lab Congress.";

const titleFR =
  "Technologies à surveiller en Médecine Esthétique | Prague Lab Aesthetic Dialogue";
const descriptionFR =
  "Découvrez toutes les technologies du marché de la médecine esthétique à suivre de près en 2026. Un article dédié à l'innovation technologique co-rédigé par Mme Eva Osvaldovà & M Julien Vervel pour le congrès Prague Lab.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Eva_Osvaldova");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://praguelab.international/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://praguelab.international/"
            target="_blank"
            title="Aesthetic Dialogue 2025"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Aesthetic Dialogue 2025"
              title="Aesthetic Dialogue 2025"
