...
const titleEN =
  "Artificial Intelligence (AI) in Aesthetic Practice | Ms. Osvaldovà Eva";
const descriptionEN =
  "Read the article by Ms. Eva Osvaldovà, CEO of the Prague Lab Congress, on the capability, strengths, and limitations of Artificial Intelligence in aesthetic practice.";

const titleFR =
  "L'intelligence artificielle (IA) dans la pratique esthétique | Mme Osvaldovà Eva";
const descriptionFR =
  "Découvrez l'article de Mme Eva Osvaldovà, CEO du congrès Prague Lab sur la capacité, les points forts et les limites de l'intelligence artificielle dans la pratique esthétique.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Eva_Osvaldova_2");
