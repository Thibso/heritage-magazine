...
import header from "@/app/img/articles/konstantin-frank/dr-konstantin-frank-heritage-magazine.png";
import logo from "@/app/img/articles/konstantin-frank/the-filler-academy-heritage-magazine.webp";
...
const titleEN = "Dr. Konstantin Frank | Interview on Face & Body Rejuvenation";
const descriptionEN =
  "Discover the exclusive interview with Dr. Konstantin Frank on the scientific rejuvenation of the face and body contour in aesthetic medicine.";

const titleFR =
  "Dr Konstantin Frank | Interview sur le rajeunissement du visage & du corps";
const descriptionFR =
  "Découvrez l'interview exclusive du Docteur Konstantin Frank sur le rajeunissement scientifique du visage et de la silhouette en médecine esthétique.";
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://thefilleracademy.com/en/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://thefilleracademy.com/en/"
            target="_blank"
            title="The Filler Academy"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="The Filler Academy"
              title="The Filler Academy"
