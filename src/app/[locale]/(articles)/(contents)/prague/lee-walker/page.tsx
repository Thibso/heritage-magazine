...
import header from "@/app/img/articles/lee-walker/dr-lee-walker-heritage-magazine.png";
import logo from "@/app/img/articles/lee-walker/lee-walker-academy-heritage-magazine.png";
...
const titleEN =
  "Dr. Lee Walker | Blindness After Hyaluronic Acid Injections in Aesthetic Medicine";
const descriptionEN =
  "Blindness after filler injections. Read Dr. Lee Walker's article on blindness and the most severe complications in aesthetic medicine.";

const titleFR =
  "Dr Lee Walker | Cécité après injections d'Acide Hyaluronique en médecine esthétique";
const descriptionFR =
  "Cécité après injections de produits de comblement. Découvrez l'article du Docteur Lee Walker sur la cécité et les complications les plus graves de la médecine esthétique.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Lee_Walker");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://leewalkeracademy.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://leewalkeracademy.com/"
            target="_blank"
            title="Lee Walker Academy"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Lee Walker Academy"
              title="Lee Walker Academy"
