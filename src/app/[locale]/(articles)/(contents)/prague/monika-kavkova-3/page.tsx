...
import header from "@/app/img/articles/monika-kavkova/dr-monika-kavkova.png";
...
const titleEN = "Controversies in Biostimulation | Dr. Kavkovà Monika";
const descriptionEN =
  "Biostimulation has become one of the fastest-growing sectors in aesthetic medicine. Dr. Kavková highlights several key controversies in biostimulation for Heritage Magazine.";

const titleFR = "Controverses dans la biostimulation | Dr Kavkovà Monika ";
const descriptionFR =
  "La biostimulation est devenue l’un des secteurs connaissant la plus forte croissance en médecine esthétique. Le Docteur Kavková met en lumière plusieurs controverses clés de la biostimulation pour Heritage Magazine.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Monika_Kavkova_3");
