...
const titleEN = "Aesthetic Medicine Market: Insights 2025 | Mr. Coste JY";
const descriptionEN =
  "Discover all the key figures for the Aesthetic Medicine market in 2025. Find the sector's trends and the geographical distribution of the market in Jean-Yves Coste's Business report.";

const titleFR = "Marché de la Médecine Esthétique : Insights 2025 | M Coste JY";
const descriptionFR =
  "Découvrez tous les chiffrés clés du marché de la Médecine Esthétique en 2025. Retrouvez les évolutions du secteur et la répartition géographique du marché dans le dossier Business de Jean-Yves Coste.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Jean_Yves_Coste");
