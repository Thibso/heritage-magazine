...
import header from "@/app/img/articles/roshan-ravidran/dr-roshan-ravidran.png";
import logo from "@/app/img/articles/roshan-ravidran/klnik-heritage-magazine.png";
...
const titleEN = "Dr. Roshan Ravindran | Advancing Aesthetic Medicine Research";
const descriptionEN =
  "Discover the exclusive article by Dr. Roshan Ravindran & Professor Lee Smith, who joined forces to advance aesthetic medicine research and address urgent sector issues.";

const titleFR =
  "Dr Roshan Ravindran | Faire progresser la recherche en Médecine Esthétique";
const descriptionFR =
  "Découvrez l'article exclusif du Docteur Roshan Ravindran & du Professeur Lee Smith qui ont uni leur force afin de faire progresser la recherche en médecine esthétique pour répondre à certaines problématiques urgentes du secteur. ";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Roshan_Ravidran");
  const tags = ["t1", "t2"] as const;
  const contents = ["p1"] as const;
  return (
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://www.klnik.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
