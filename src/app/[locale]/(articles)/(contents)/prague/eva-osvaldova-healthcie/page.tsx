...
const titleEN = "Managing an Aesthetic Clinic in 2026 | Strategies for Success";
const descriptionEN =
  "Learn everything about the management and growth of an Aesthetic Medicine Clinic in 2026. A cross-perspective with Ms. Eva Osvaldovà and Mr. Julien Vervel, CEO of HEALTHCIE.";

const titleFR =
  "Gérer une Clinique Esthétique en 2026 | Stratégies pour réussir";
const descriptionFR =
  "Découvrez l'article pour tout savoir sur la gestion et le développement d'une Clinique de Médecine Esthétique en 2026. Regards croisés avec Mme Eva Osvaldovà et M Julien Vervel, CEO de HEALTHCIE.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Eva_Osvaldova_Healthcie");
