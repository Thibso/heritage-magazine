...
import logo from "@/app/img/articles/biosolution/biosolution-co-hearitage-magazine.png";
import header from "@/app/img/articles/biosolution/biosolution-co.jpg";
...
const titleEN = "Micro-Needle Assisted Exosome Delivery | Biosolution";
const descriptionEN =
  "Discover HERITAGE Magazine’s exclusive article dedicated to the enhanced skin penetration of an exosome-based formulation thanks to micro-needle assisted delivery by Korean Laboratory Biosolution.";

const titleFR =
  "Administration d’exosomes assistée par Micro-aiguilles | Biosolution";
const descriptionFR =
  "Découvrez l’article exclusif d’HERITAGE Magazine dédié à la pénétration cutannée améliorée d’une formulation à base d’exosomes grâce à une administration assistées par microneedles par le Laboratoire Coréen Biosolution. ";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Exosomes");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://bio-solution.co.kr/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://bio-solution.co.kr/"
            target="_blank"
            title="BioSolution.Co"
          ...
          >
            <Image
              ...
              alt="BioSolution.Co"
              title="BioSolution.Co"
              className="size-full lg:max-w-[300px] max-h-[350px] max-lg:max-w-[450px] object-contain m-auto"
            />
