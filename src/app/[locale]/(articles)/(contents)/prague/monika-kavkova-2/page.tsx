...
const titleEN = "Hyaluronic Acid Fillers | Dr. Kavkovà Monika";
const descriptionEN =
  "HA: Beauty enhancer or destroyer? Read the full article on balancing Hyaluronic Acid filler injections with Dr. Monika Kavkovà.";

const titleFR = "Acides hyaluroniques de remplissage | Dr Kavkovà Monika";
const descriptionFR =
  "L'AH : amplificateur ou destructeur de beauté ? Découvrez l'article complet sur l'équilibre des injections d'acide hyaluronique de remplissage avec le Docteur Monika Kavkovà.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Monika_Kavkova_2");
