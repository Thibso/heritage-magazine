...
import logo from "@/app/img/articles/steven-harris/dr-steven-harris-magazine-heritage.webp";
import header from "@/app/img/articles/steven-harris/dr-steven-harris.png";
...
const titleEN =
  "Instagram VS Reality in Aesthetic Medicine | Dr. Steven Harris";
const descriptionEN =
  "Read Dr. Steven Harris's article evaluating the representation of aesthetic lip subtypes on social media. Instagram VS Reality in aesthetic medicine.";

const titleFR =
  "Instagram VS Realité en Médecine Esthétique | Dr Steven Harris";
const descriptionFR =
  "Découvrez l'article du Dr Steven Harris sur l'évaluation de la représentation des sous-types esthétiques des lèvres sur les Réseaux Sociaux. Instagram VS Realité en médecine esthétique.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Steven_Harris");
      ...
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://harrisclinic.co.uk/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
