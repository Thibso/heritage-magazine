...
import header from "@/app/img/articles/skinceuticals/skinceuticals-heritage-magazine.jpg";
import logo from "@/app/img/articles/skinceuticals/skinceuticals-logo.png";
...
const titleEN = "SKINCEUTICALS | Pioneer of Integrated Skincare";
const descriptionEN =
  "Read our media's exclusive article dedicated to SKINCEUTICALS Laboratory, a pioneer of science-based integrated skincare. Cosmetology & Aesthetic Medicine by HERITAGE Magazine.";

const titleFR = "SKINCEUTICALS | Pionnier des soins de la peau intégrés";
const descriptionFR =
  "Découvrez l’article de notre média dédié au Laboratoire SKINCEUTICALS, pionnier des soins de la peau intégrés basés sur la science. Cosmétologie & Médecine esthétique par HERITAGE Magazine.";
...
export default function Article() {
  const t = useTranslations("Articles.Prague_Skinceuticals");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://www.skinceuticals.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://www.skinceuticals.com/"
            target="_blank"
            title="SkinCeuticals"
