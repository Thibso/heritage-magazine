...
import header from "@/app/img/articles/merete-haedersdal/pr-haedersdal-heritage-magazine.jpg";
...
const titleEN =
  "Dr. Haedersdal | At the heart of dermatological innovation with IMCAS";
const descriptionEN =
  "Discover the interview with Dr Haedersdal, Associate Scientific Director of the IMCAS congress on the subject of innovation in clinical dermatology. (H)ERITAGE Magazine";

const titleFR =
  "Dr Haedersdal | Au cœur de l’innovation dermatologique avec l'IMCAS";
const descriptionFR =
  "Découvrez l’interview du Docteur Haedersdal, directrice scientifique associée du congrès IMCAS sur le sujet de l'innovation en dermatologie clinique. (H)ERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Merete_haedersdal");
