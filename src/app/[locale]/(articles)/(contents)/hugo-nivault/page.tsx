...
const titleEN = "Nivault Hugo | Preparing your digital project | HERITAGE";
const descriptionEN =
  "Discover Hugo Nivault's exclusive feature on “how to prepare your digital project as a doctor?” (H)ERITAGE Magazine";

const titleFR = "Nivault Hugo | Dossier Préparer son projet digital | HERITAGE";
const descriptionFR =
        ...
        <div className="col-span-2">
          ...
          >
            <Image
              ...
              className="size-full max-h-[300px] max-lg:max-w-[450px] object-contain m-auto test"
            />
