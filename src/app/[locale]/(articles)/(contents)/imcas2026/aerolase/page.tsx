...
import logo from "@/app/img/articles/imcas2026/aerolase/aerolase-heritage-magazine.png";
import header from "@/app/img/articles/imcas2026/aerolase/efremkin-pavel-aerolase-heritage-magazine.png";
...
const titleEN =
  "Pavel Efremkin | Aerolase CEO: Aerospace-Inspired Laser Innovation";
const descriptionEN =
  "An interview with Pavel Efremkin, CEO of Aerolase. Discover how 650-microsecond technology redefines laser care: medical efficacy, pain-free, and safe for all skin types.";

const titleFR =
  "Pavel Efremkin | CEO Aerolase : L'Innovation Laser Inspirée de l'Aérospatial";
const descriptionFR =
  "Rencontre avec Pavel Efremkin, CEO d'Aerolase. Découvrez comment la technologie 650 microsecondes redéfinit le soin laser : efficacité médicale, sans douleur et pour tous les types de peau.";
...
export default function Article() {
  const t = useTranslations("Articles.imcas2026_aerolase");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://www.aerolase.com/?r=0" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://www.aerolase.com/?r=0"
            target="_blank"
            title="Aerolase"
