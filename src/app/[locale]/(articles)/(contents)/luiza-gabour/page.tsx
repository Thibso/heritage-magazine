...
import logo from "@/app/img/articles/luiza-gabour/maitre-luiza-gabour-hearitage-magazine.png";
import header from "@/app/img/articles/luiza-gabour/maitre-luiza-gabour-heritage-magazine.jpg";
...
const titleEN =
  "Ms Gabour Luiza | Regulation of botulinum toxin in France and Europe";
const descriptionEN =
  "Discover Maitre Luiza Gabour's comparative study on the regulation of botulinum toxin in France and other European countries. HERITAGE Magazine";

const titleFR =
  "Maitre Gabour Luiza | Règlementation de la toxine botulique en France & en Europe";
const descriptionFR =
  "Découvrez l'étude comparée de Maitre Luiza Gabour sur la réglementation de la toxine botulique en France et dans les pays Européens. HERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Luiza_Gabour");
      ...
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://gabour-avocat.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
