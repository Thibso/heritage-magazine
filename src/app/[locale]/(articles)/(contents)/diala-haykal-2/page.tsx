...
import header from "@/app/img/articles/diala_haykal/dr-diala-haykal-hydrafacial-heritage-magazine.jpg";
...
const titleEN =
  "Dr Haykal Diala | Artificial intelligence revolutionises the teaching of dermatological diagnosis";
const descriptionEN =
  "Discover Dr Diala Haykal's focus on automated learning & diagnostic training in dermatology with artificial intelligence. HERITAGE Magazine";

const titleFR =
  "Dr Haykal Diala | L'intelligence artificielle révolutionne l'enseignement des diagnostics dermatologiques";
const descriptionFR =
  "Découvrez le focus du Docteur Diala Haykal sur l'apprentissage automatisé & la formation des diagnostics en dermatologie avec l'intelligence artificielle. HERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Diala_Haykal_2");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://centre-laser-palaiseau.fr/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://centre-laser-palaiseau.fr/"
            target="_blank"
            title="Centre Laser Palaiseau"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Centre Laser Palaiseau"
              title="Centre Laser Palaiseau"
