...
import header from "@/app/img/articles/nooance/dorothee-delamer-directrice-nooance-heritage-magazine.jpg";
import logo from "@/app/img/articles/nooance/nooance-logo-heritage-magazine.png";
...
const titleEN =
  "Delamer Dorothée | Interview with the specialist in Augmented Anti-Ageing Care | NOOANCE";
const descriptionEN =
  "Discover Dorothée Delamer's exclusive interview with the French specialist in augmented anti-ageing skincare. (H)ERITAGE Magazine";

const titleFR =
  "Delamer Dorothée | Interview du spécialiste du soin anti-âge augmenté | NOOANCE";
const descriptionFR =
  "Découvrez en exclusivité l’interview de Dorothée Delamer sur le spécialiste français du soin anti-âge augmenté. (H)ERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Nooance");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://www.nooance-paris.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://www.nooance-paris.com/"
            target="_blank"
            title="NOOĀNCE"
