...
import logo from "@/app/img/articles/romain-foucourt/docteur-foucourt-logo-heritage-magazine.png";
import header from "@/app/img/articles/romain-foucourt/docteur-romain-foucourt-heritage-magazine.jpg";
...
const titleEN = "Dr. Foucourt | Medical Cosmetology and the Rosacea Management";
const descriptionEN =
  "Discover Dr Foucourt's technique on medical cosmetology and the treatment of rosacea in aesthetic medicine. (H)ERITAGE Magazine";

const titleFR =
  "Dr Foucourt | Cosmétologie Médicale et Traitement de la Rosacée";
const descriptionFR =
  "Découvrez la technique du Dr Foucourt sur la cosmétologie médicale et le traitement de la rosacée en médecine esthétique. (H)ERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Romain_Foucourt");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://drfoucourt.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://drfoucourt.com/"
            target="_blank"
            title="Dr Romain Foucourt"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Dr Romain Foucourt"
              title="Dr Romain Foucourt"
