...
const titleEN =
  "Vervel Julien | Focus on Visibility & Referencing on AI with GEO";
const descriptionEN =
  "Discover the article on visibility and search engine optimisation for doctors and cosmetic surgeons on AI engines (GEO)";

const titleFR =
  "Vervel Julien | Dossier Visibilité & Référencement sur les intelligences artificielles";
const descriptionFR =
  "Découvrez l'article sur la visibilité & le référencement des médecins et des chirurgiens esthétiques sur les moteurs IA (GEO)";
...
export default function Article() {
  const t = useTranslations("Articles.Julien_Vervel_2");
