...
import logo from "@/app/img/articles/thomas-josse/agence-thomas-josse-heritage-magazine.png";
import header from "@/app/img/articles/thomas-josse/thomas-josse-heritage-magazine.jpg";
...
const titleEN =
  "Josse Thomas | A concierge service & Club for members of the Aesthetics industry";
const descriptionEN =
  "Discover Thomas Josse's concierge service and private club for professionals in aesthetic medicine and plastic surgery. HERITAGE Magazine";

const titleFR =
  "Josse Thomas | Une conciergerie & un club pour les acteurs de l'Esthétique";
const descriptionFR =
  "Découvrez la conciergerie et le club privé de Thomas Josse pour les acteurs de la médecine et de la chirurgie esthétique. HERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Thomas_Josse");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://agencethomasjosse.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://agencethomasjosse.com/"
            target="_blank"
            title="Agence Thomas Josse"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Agence Thomas Josse"
              title="Agence Thomas Josse"
