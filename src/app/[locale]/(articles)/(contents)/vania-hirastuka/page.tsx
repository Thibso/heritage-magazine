import header from "@/app/img/articles/vania-hiratsuka/vania-hiratsuka-dalmedo-heritage-magazine.jpeg";
...
const titleEN =
  "Dr. Hiratsuka Dalmedo | Botulinum Toxin for Bruxism & Masseteric Hypertrophy";
const descriptionEN =
  "Discover Dr Hiratsuka Dalmedo's technique for bruxism & masseteric hypertrophy treatment. (H)ERITAGE Magazine";

const titleFR =
  "Dr Hiratsuka Dalmedo | Toxine Botulique pour le Bruxisme et l'Hypertrophie Massétérique";
const descriptionFR =
  "Découvrez la technique du Dr Hiratsuka Dalmedo pour le traitement du bruxisme et de l'hypertrophie massétérique. (H)ERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Vania_Hirastuka");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            {/* <div>
              <Button link="https://magazine-heritage.com/" target="_blank">
                {t("cta_text")}
              </Button>
            </div> */}
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://magazine-heritage.com/"
            target="_blank"
            title="Heritage Magazine"
          ...
          >
            <Image
              ...
              title="Heritage Magazine"
              className="size-full max-h-[350px] max-w-[450px]  max-lg:max-w-[450px] object-contain m-auto"
              quality={100}
            />
              ...
              {t.rich(`${key}.content`, {
                ...
                img: (chunk) => (
                  <Image
                    ...
                    width={1080}
                    height={1080}
                    className="py-8 h-full object-contain"
                  />
                ),
                bigImg: (chunk) => (
                  <Image
