...
import header from "@/app/img/articles/carrie-caulkins/carrie-caulkins-hydrafacial-heritage-magazine.jpg";
import imgLeft from "@/app/img/articles/carrie-caulkins/heritage-magazine-hydrafacial.jpg";
import imgRight from "@/app/img/articles/carrie-caulkins/hydrafacial-heritage-magazine.jpg";
...
const titleEN =
  "Caulkins Carrie | Exclusive interview with the Hydrafacial's CMO";
const descriptionEN =
  "Discover the interview with Carrie Caulkins on the benefits of Hydrafacial for skin quality. The exclusive interview with the Chief Marketing Officer of the Hydrafacial brand for HERITAGE Magazine.";

const titleFR =
  "Caulkins Carrie | Interview exclusive avec la CMO d'Hydrafacial";
const descriptionFR =
  "Découvrez l'interview de Madame Carrie Caulkins sur les avantages d'Hydrafacial pour la qualité de la peau. L'entretien exclusif avec la Chief Marketing Officer de la marque Hydrafacial pour HERITAGE Magazine.";
...
export default function Article() {
  const t = useTranslations("Articles.Carrie_Caulkins");
        ...
        <div className="col-span-3 space-y-8 lg:space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Image
              ...
              width={1080}
              height={720}
              className="aspect-[12/16] object-cover"
            />
            <Image
              src={imgRight}
              alt="Hydrafacial"
