...
import header from "@/app/img/articles/fauad-hasan/fauad-hasan-heritage-magazine.jpg";
import logo from "@/app/img/articles/fauad-hasan/fynash-fauad-hasan-heritage-magazine.png";
...
const titleEN =
  "Hasan Fauad | The future of personalised aesthetic medicine thanks to Artificial Intelligence";
const descriptionEN =
  "Discover Fauad Hasan's focus on the future of aesthetic medicine thanks to artificial intelligence. HERITAGE Magazine";

const titleFR =
  "Hasan Fauad | Avenir de la médecine esthétique personnalisée grâce à l'Intelligence Artificielle";
const descriptionFR =
  "Découvrez le focus de Fauad Hasan sur le futur de la médecine esthétique grâce à l'intelligence artificielle. HERITAGE Magazine";
...
export default function Article() {
  const t = useTranslations("Articles.Fauad_Hasan");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button
                link="https://www.linkedin.com/in/fauad-hasan-052a1a2/"
                target="_blank"
              >
                {t("cta_text")}
              </Button>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://www.linkedin.com/in/fauad-hasan-052a1a2/"
            target="_blank"
            title="Fauad Hasan"
