...
import logo from "@/app/img/articles/dr-raza/dr-raza-logo-heritage-magazine.png";
import header from "@/app/img/articles/dr-raza/dr-raza-rhinoplastie-specialist-heritage-magazine.jpeg";
...
const titleEN = "Dr. Razafimahefa | Hybrid Rhinoplasty | Rhinoplasty 3.0";
const descriptionEN =
  "Discover Doctor Razafimahefa's hybrid rhinoplasty technique in ENT surgery. (H)ERITAGE Magazine";

const titleFR = "Dr Razafimahefa | La Rhinoplastie Hybride | Rhinoplastie 3.0";
const descriptionFR =
  "Découvrez la technique du Docteur Razafimahefa sur la rhinoplastie hybride  en chirurgie ORL. Magazine (H)ERITAGE";
...
export default function Article() {
  const t = useTranslations("Articles.Tantely_Raza");
    ...
    <div>
      <section className="myContainer lg:space-x-16 full-screen max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="lg:col-span-3 flex flex-col justify-around gap-8">
          <div className="flex flex-col justify-between gap-4 lg:gap-6">
            ...
            <div>
              <Button link="https://rhinoplastie-toulon.fr/" target="_blank">
                {t("cta_text")}
              </Button>
            </div>
          </div>
      ...
      <section className="myContainer lg:space-x-16 max-lg:flex max-lg:flex-col-reverse max-lg:gap-10 lg:grid lg:grid-cols-5 text-mainBlue">
        ...
        <div className="col-span-2">
          <a
            href="https://rhinoplastie-toulon.fr/"
            target="_blank"
            title="Dr Tantely Razafimahefa"
            className="lg:sticky lg:top-[35%] flex flex-col items-center gap-4"
          >
            <Image
              src={logo}
              alt="Dr Tantely Razafimahefa"
              title="Dr Tantely Razafimahefa"
